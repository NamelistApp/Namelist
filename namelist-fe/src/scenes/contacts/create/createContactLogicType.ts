// Generated by kea-typegen on Thu, 02 Jan 2025 14:21:57 GMT. DO NOT EDIT THIS FILE MANUALLY.
...
export interface createContactLogicType extends Logic {
    actionCreators: {
        loadContacts: () => ({
            type: "load contacts (scenes.contacts.create.createContactLogic)";
            payload: any;
        });
    ...
    actionKeys: {
        "load contacts (scenes.contacts.create.createContactLogic)": "loadContacts";
    ...
    actionTypes: {
        loadContacts: "load contacts (scenes.contacts.create.createContactLogic)";
