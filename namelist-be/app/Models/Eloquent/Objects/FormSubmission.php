...
class FormSubmission extends CrmObject
{
    protected static function booted(): void
    {
        static::addGlobalScope('object_type', function (Builder $builder) {
            $builder->where('crm_object_type_id', ObjectTypeId::FormSubmission);
        });

        static::creating(function ($contact) {
            $contact->crm_object_type_id = ObjectTypeId::FormSubmission;
        });
    }
}
